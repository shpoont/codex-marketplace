...
```text
Add this project to recurring AGENTS.md self-improvement reviews using these source tasks, every day at 09:00 in my timezone.
```
...
- **Storage:** project paths, task IDs, schedule IDs, destinations and extra
  boundaries live in
  `$CODEX_HOME/agents-md-self-improvement/projects.json`, defaulting to
  `~/.codex/agents-md-self-improvement/projects.json`.
...
Current version: `0.1.7`. See the [public changelog](CHANGELOG.md) for released
